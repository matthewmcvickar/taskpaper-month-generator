...
(function() {
  $(function() {
    var client, currentMonth, currentYear, defaultTaskList, emptyButton, generateTaskPaperMonth, getLocationParameters, items, itemsField, locationParameters, month, nextYear, spliceText, thisYear, today, year;
