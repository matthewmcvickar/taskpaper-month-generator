...
(function() {
  $(function() {
    var client, currentMonth, currentYear, defaultTaskList, emptyButton, generateTaskPaperMonth, items, itemsField, month, nextYear, spliceText, thisYear, today, url, year;
    defaultTaskList = '1\nto-do item\n\n14\nanother task\n\tnotes\n\n29\ntask\nyet another task\n\tnotes and details\n\tanother note';
